<h1 align="center">
 <img src="https://user-images.githubusercontent.com/45159366/120938264-b8221e00-c6c6-11eb-8fa7-32a3d0b7f6c6.png">
  <br />
  Wix Guide
</h1>

#### A guide covering Wix including the applications and tools that will make you a better and more efficient web developer with Wix.
...
3. [HTML/CSS Development](https://github.com/mikeroyal/Wix-Guide#hmtlcss-development)
...
6. [Ruby Development](https://github.com/mikeroyal/Wix-Guide#ruby-development)

7. [Java Development](https://github.com/mikeroyal/Wix-Guide#java-development)

8. [Python Development](https://github.com/mikeroyal/Wix-Guide#python-development)

9. [Databases](https://github.com/mikeroyal/Wix-Guide#databases)

10. [Networking](https://github.com/mikeroyal/Wix-Guide#networking)

<p align="center">
 <img src="https://user-images.githubusercontent.com/45159366/120938265-b9534b00-c6c6-11eb-8a97-b38d4bd971a2.png">
  <br />
</p>

# Wix Learning Resources
[Back to the Top](https://github.com/mikeroyal/Wix-Guide#table-of-contents)

[Wix](https://www.wix.com/) is a leading cloud-based development platform with millions of users worldwide. Wix makes it easy for everyone to create a beautiful, professional website. Whether you want to  promote your business, showcase your art, set up an online shop or just test out new ideas.
...
[Wix Training Academy YouTube Videos]()

[Wix eCommerce School Online Courses](https://www.wix.com/ecommerce/online-courses)

[Learning Wix Online Class on LinkedIn Learning](https://www.linkedin.com/learning/learning-wix)

[Top Wix Courses on Udemy](https://www.udemy.com/topic/wix/)

[Wix Masterclass: Create a Stunning Wix Site on Udemy](https://www.udemy.com/course/wix-course/)

[Develop a Company Website with Wix Course on Coursera](https://www.coursera.org/projects/develop-a-company-website-with-wix)

[Intro to the WiX Toolset Tutorial on Pluralsight](https://www.pluralsight.com/courses/wix-introduction)

[WIX E-Commerce: Tutorial for Beginners on ProfileTree](https://profiletree.com/wix-ecommerce/)

# Wix Tools & Frameworks
[Back to the Top](https://github.com/mikeroyal/Wix-Guide#table-of-contents)

[WiX Toolset](https://wixtoolset.org) is a set of build tools that build Windows Installer packages using the same build concepts as the rest of your product: source code is compiled and then linked to create executables; such as .exe setup bundles, .msi installation packages, .msm merge modules, and .msp patches. The WiX command-line build tools work with any automated build system. Also, MSBuild is supported from the command line, Visual Studio, and Team Build.

[Wix Toolset Visual Studio Extension](https://marketplace.visualstudio.com/items?itemName=WixToolset.WiXToolset) is an extension to get build integration with WiX in Visual Studio.

[Wix Enterprise](https://www.wix.com/enterprise) is a suite of features that provides a secure, scalable solution for your brand.

[Wix Logo Maker](https://www.wix.com/logo/maker) is a tool you can design a logo that looks exactly the way you want. Each logo is completely customizable allowing you to change the font, color, size, text and more to fit your brand. Plus, you get full commercial use rights of any logo you create.

[Wix Video Maker](https://www.wix.com/tools/video-maker) is a tool that makes it easy for you to create promo videos, product demos, social posts and more. Create a video to tell people what’s new, announce a sale, celebrate a milestone or share an exciting update. 

[Wix Free Paystub Generator](https://www.wix.com/tools/pay-stub-generator) is a tool that instantly create and deliver professional pay stubs for your employees.

[Wix Free QR Codes](https://www.wix.com/tools/qr-code-generator) is a tool that let you create your own custom, high-quality QR codes with Wix QR Code Generator. Use QR codes to drive traffic and increase sales when customers scan your printed or digital code.

[Wix Free Invoice Generator](https://www.wix.com/tools/invoice-generator) is a tool that lets you create custom invoices for your business—free. Enter your contact info, add client details and describe your billing items. When you’re done, send your invoice directly to your clients or download a PDF copy from your email.

[Wix Business Name Generator](https://www.wix.com/tools/business-name-generator) is a tool that helps you get the perfect name for your brand.

[Wix Website Design](https://www.wix.com/website/design) is a tool that brings your vision to life with beautiful design and infinite ways to create.

[Wix Website Templates](https://www.wix.com/website/templates) is a tool that provides over 800 designer-made website templates.

[Wix Advanced Web Development](https://www.wix.com/velo) is a tool that builds web applications on Velo's open dev platform.

[Wix Blog Website](https://www.wix.com/start/blog) is a tool to help you share ideas with your audience and drive traffic to your website.

[Wix Portfolio Website](https://www.wix.com/portfolio-website) is a tool that helps you create a professional website dedicated to your creative work.

[Wix Editor X](https://www.editorx.com/) is a tool that helps you design fluid sites with CSS grid, flexbox layouts and custom breakpoints.

[Wix Domain Name](https://www.wix.com/domain/names) is a service to get a unique URL to help visitors find you online.

[Wix SEO Toolset](https://www.wix.com/seo) is a service to grow your organic traffic with built-in advanced SEO tools.

[Wix Website Security](https://www.wix.com/website-security) is a service that offers your visitors secure browsing with your own SSL certificate.

[Wix Free Web Hosting](https://www.wix.com/free/web-hosting) is a service that gives secure hosting, included storage and top CDN performance.

[Wix Roles & Permissions](https://www.wix.com/manage/roles-and-permissions) is a service that invites others to collaborate on your website and work smarter together.

[Wix Multilingual Website](https://www.wix.com/localization/multilingual) is a service that adds languages to reach visitors around the world.

[Wix Mobile App](https://www.wix.com/mobile/wix-app) is a service that runs every part of your business and chat with visitors on the go.

[Wix Analytics](https://www.wix.com/manage/analytics) is a service that monitors website traffic and optimize your performance.

[Wix Online Store](https://www.wix.com/ecommerce/website) is a service that helps you sell products and manage fulfillment from one eCommerce platform.

[Wix Orders & Fulfillment](https://www.wix.com/ecommerce/manage) is a service that helps you manage orders, shipping and fulfillment from a single dashboard.

[Wix Dropshipping](https://www.wix.com/ecommerce/dropshipping) is a service that helps you find print on demand and dropshipping products to sell.

[Services & Memberships](https://www.wix.com/scheduling-software) is a service that helps you list services, memberships & packages for purchase online.

[Wix Online Payments](https://www.wix.com/payments) is a service that helps you give customers flexibility with multiple ways to pay.

[Wix Multichannel Sales](https://www.wix.com/ecommerce/sell) is a service that helps you sell across platforms like Facebook & Instagram.

[Wix Point of Sale(POS)](https://www.wix.com/pos) is a service that helps you sell online and in-store seamlessly with a unified catalog and inventory.

[Wix Online Scheduling](https://www.wix.com/scheduling-software) is a service that helps you let clients book and purchase your services online.

[Wix Business Email](https://www.wix.com/business/email-address) is a service that helps you look professional with an email address that uses your domain.

[Wix Business Phone Number](https://www.wix.com/business-phone-number) is a service that helps you connect with clients from a dedicated business line.

[Wix Ascend Business Solution](https://www.wix.com/ascend/home) is a service that helps you generate leads and track invoices & quotes with a suite of built-in tools.

[Wix Analytics & Reports](https://www.wix.com/manage/analytics) is a service that helps you track sales, monitor website traffic and optimize your performance.

[Wix Email Marketing](https://www.wix.com/ascend/email-marketing) is a service that helps you get the word out about sales and track your campaigns.

[Wix Social Posts](https://www.wix.com/ascend/social-media-graphics) is a service that helps you reach a wider audience with eye-catching posts.

[Wix Facebook Ads](https://www.wix.com/features/facebook-ads) is a service that helps you target the right customers with Wix's AI optimization.

[Wix Lead Capture Tools](https://www.wix.com/ascend/lead-capture) is a service that helps you chat live with website visitors and create contact forms.

[Financial Tools](https://www.wix.com/ascend/collect-payments) is a service that helps you cend quotes & invoices to negotiate and close deals.

[Wix CRM by Ascend](https://www.wix.com/ascend/crm) is a service that helps you capture leads, talk to customers and streamline your workflow.

[Wix Community Management](https://www.wix.com/business/community) is a service that helps you create an engaged client network with a blog, groups & forums.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Wix-Guide/pulls).
